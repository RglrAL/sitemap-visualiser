...
(function() {
    ...
    // IMMEDIATE EXPORT - Export function as soon as it's defined
    window.createEnhancedCitizensDashboard = createEnhancedCitizensDashboard;
    console.log('🚀 createEnhancedCitizensDashboard exported immediately');
...
Generated by Citizens Information Analytics Dashboard
    ...
    // ===========================================
    // GLOBAL EXPORTS - ENSURE THESE ARE AVAILABLE
    // ===========================================

    // Export immediately to prevent issues
    window.createEnhancedCitizensDashboard = createEnhancedCitizensDashboard;
    ...
    // Debug logging
    console.log('✅ Enhanced Citizens Dashboard functions exported to window:');
    console.log('- createEnhancedCitizensDashboard:', typeof window.createEnhancedCitizensDashboard);
    console.log('- initializeEnhancedDashboard:', typeof window.initializeEnhancedDashboard);
    
    // Test function availability
    if (typeof window.createEnhancedCitizensDashboard !== 'function') {
        console.error('❌ createEnhancedCitizensDashboard not properly exported!');
    } else {
        console.log('✅ createEnhancedCitizensDashboard is ready to use');
    }

})();

// Additional fallback export outside IIFE
(function() {
    'use strict';
    
    // If the main export failed, try a direct approach
    if (typeof window.createEnhancedCitizensDashboard !== 'function') {
        console.log('🔄 Attempting fallback export...');
        
        // Re-export the function if it exists in a different scope
        if (typeof createEnhancedCitizensDashboard === 'function') {
            window.createEnhancedCitizensDashboard = createEnhancedCitizensDashboard;
            console.log('✅ Fallback export successful');
        } else {
            console.error('❌ Function not found in any scope');
        }
    }
})();
